...
def score(reference_path: Path, synth_path: Path, output_dir: Path, dz_source: Path | None):
    ...
    dz = climatological_dz(dz_source) if dz_source and dz_source.exists() else None
    ...
    lines = [
        ...
        "",
        "The metric code, ERA5 reference, held-out dates, levels, and grid match benchmark v2. "
...
def main(argv=None) -> None:
    ...
    score(args.reference, args.synthwinds, args.output_dir, args.dz_source)
