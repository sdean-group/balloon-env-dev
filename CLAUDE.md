...
- `/Users/shauryasen/Dev/shaurya-hub/research/HANDOFF.md` — where things stand, how to run everything, and the gotchas. Read it at the start of a session; rewrite it when handing off.
