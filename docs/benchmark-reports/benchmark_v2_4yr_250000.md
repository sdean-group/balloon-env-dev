...
|---|---|---|---|---|---|---|---|---|---|---|
| SR_E (lower) | 0.25 | 5.76 | 8.96 | 0.75 | 3.19 | 2.73 | 2.09 | 1.53 | 1.74 | 1.00 |
| SR_div (lower) | 0.25 | 5.47 | 8.98 | 0.87 | 3.24 | 5.23 | 2.14 | 1.56 | 1.70 | 1.04 |
| SR_vort (lower) | 0.25 | 5.85 | 8.99 | 0.72 | 3.14 | 2.16 | 2.10 | 1.53 | 1.82 | 0.98 |
| L_eff (km) (lower) | 56.12† | 56.12† | 3367.43 | 56.12† | 93.54 | 841.86 | 673.49 | 336.74 | 481.06 | 198.08 |
| W1 shear u ((m/s)/km) (lower) | 0.20 | 39.63 | 18.44 | 0.31 | 0.41 | 3.62 | 1.70 | 1.00 | 0.87 | 0.38 |
| W1 shear v ((m/s)/km) (lower) | 0.10 | 18.11 | 15.33 | 0.97 | 0.64 | 0.61 | 1.62 | 1.01 | 0.71 | 0.11 |
...
| Metric (see METRIC_INFO) | self-split floor | phase shuffle | white noise | simplex noise | helmholtz gp | ble_vae | idiff trained | idiff m2cond | coarse upsampled | idiff m2coarse |
|---|---|---|---|---|---|---|---|---|---|---|
| W1 u (m/s) (lower) | 1.07 | 8.78 | 0.53 | 1.12 | 0.94 | 17.92 | 4.26 | 3.82 | 1.93 | 1.77 |
| W1 v (m/s) (lower) | 0.65 | 2.59 | 0.38 | 0.40 | 0.33 | 4.89 | 3.00 | 3.74 | 0.56 | 0.44 |
| tail err 1% (m/s) (lower) | 2.01 | 5.65 | 1.53 | 1.73 | 1.31 | 15.36 | 11.52 | 10.64 | 4.08 | 3.57 |
| tail err 0.1% (m/s) (lower) | 2.92 | 5.97 | 2.59 | 2.34 | 1.42 | 18.94 | 15.59 | 13.54 | 5.91 | 5.05 |
| W1 speed (m/s) (lower) | 1.11 | 1.21 | 1.14 | 1.69 | 1.21 | 4.56 | 3.85 | 2.98 | 0.19 | 0.11 |
| jet speed err 99% (m/s) (lower) | 4.75 | 3.93 | 4.53 | 3.41 | 2.82 | 9.51 | 12.85 | 10.16 | 0.82 | 0.34 |
| jet speed err 99.9% (m/s) (lower) | 5.63 | 3.19 | 6.76 | 4.20 | 3.45 | 11.99 | 17.56 | 12.88 | 1.39 | 0.61 |
| W1 cond (m/s) (lower) | 2.38 | 7.40 | 3.13 | 3.38 | 3.22 | N/A | 3.87 | 3.52 | 0.22 | 0.04 |
...
| Metric (see METRIC_INFO) | self-split floor | phase shuffle | white noise | simplex noise | helmholtz gp | ble_vae | idiff trained | idiff m2cond | coarse upsampled | idiff m2coarse |
|---|---|---|---|---|---|---|---|---|---|---|
| opp-wind frac (≈ref) | 0.20 | 1.00 | 0.78 | 0.23 | 0.39 | 0.58 | 0.01 | 0.04 | 0.18 | 0.19 |
| opp-wind err (lower) | 0.00 | 0.80 | 0.58 | 0.02 | 0.19 | 0.37 | 0.19 | 0.16 | 0.03 | 0.01 |
| jet area ratio (≈1*) | 1.42 | 0.77 | 0.04 | 0.65 | 0.08 | 0.68 | 0.36 | 0.59 | 1.55 | 1.04 |
| jet elong ratio (≈1) | 1.17 | 1.10 | 0.87 | 0.85 | 0.70 | 1.76 | 0.93 | 0.95 | 0.88 | 0.93 |
